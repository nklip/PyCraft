...
from api.tests.test_cart import add_meal_item_in_cart, create_margarita, create_pizza
...
class OrdersTestCase(TestCase):
    def setUp(self):
        ...
        self.manager = User.objects.create_user(username="manager@manager.com", password="manager")
    ...
    def test_delivery_lifecycle(self):
        ...
        response = self.client.get(path=f"/api/orders/{order_id}", format="json")
        ...
        order_change = {"delivery_id": self.delivery1.id}
