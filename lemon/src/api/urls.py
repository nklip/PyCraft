...
from .views.menu_items import MealsView, MealView
from .views.orders import OrdersView, OrderView
from .views.user_groups import DeliveryCrewView, DeliveryPersonView, ManagersView, ManagerView
...
urlpatterns = [
    ...
    path(
        ...
        DeliveryPersonView.as_view(),
        name="delivery-person-view",
    ),
]
